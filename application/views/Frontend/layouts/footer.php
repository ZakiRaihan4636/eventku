  ...
  <!-- Jquery JS-->
  <script src="<?php echo base_url(''); ?>assets/assets/vendor-daftar/jquery/jquery.min.js"></script>
  <!-- Vendor JS-->
  <script src="<?php echo base_url(''); ?>assets/assets/vendor-daftar/select2/select2.min.js"></script>
  <script src="<?php echo base_url(''); ?>assets/assets/vendor-daftar/datepicker/moment.min.js"></script>
  <script src="<?php echo base_url(''); ?>assets/assets/vendor-daftar/datepicker/daterangepicker.js"></script>

  <!-- Main JS-->
  <script src="<?php echo base_url(''); ?>assets/assets/js-daftar/global.js"></script>
